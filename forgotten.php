<?php
	...
	if (isset($_POST['submit'])) {
		...
		if ($password != $cPassword)
			...
			$con->query("UPDATE `users` SET `Password`='$hash' WHERE Email = '$email';");
		...
		<div class="row justify-content-center">
			<div class="col-md-6 col-md-offset-3" align="center">
				...
				<form method="post" action="forgotten.php">
					...
					<input class="form-control" minlength="5" name="password" type="password" placeholder="New Password..."><br>
					<input class="form-control" minlength="5" name="cPassword" type="password" placeholder="Confirm New Password..."><br>
